package mp4
{
    ...
    public class FLVTagVideo extends FLVTag
    {
        ...
        public static const CODEC_ID_NONE:int = -1;
        ...
        public function get avcCompositionTimeOffset() : int
        {
            ...
            var _loc_1:* = bytes[TAG_HEADER_BYTE_COUNT + 2] << 16;
            _loc_1 = _loc_1 | bytes[TAG_HEADER_BYTE_COUNT + 3] << 8;
            _loc_1 = _loc_1 | bytes[TAG_HEADER_BYTE_COUNT + 4];
            if (_loc_1 & 8388608)
            {
                _loc_1 = _loc_1 | 4278190080;
            }
            return _loc_1;
        }// end function
        ...
        override public function get data() : ByteArray
        {
            ...
            if (this.codecID == CODEC_ID_AVC)
            {
                _loc_1.writeBytes(bytes, TAG_HEADER_BYTE_COUNT + 5, dataSize - 5);
            }
            else
            {
        ...
        override public function writeHeader(param1:ByteArray) : void
        {
            if (this.codecID == CODEC_ID_AVC)
            {
                param1.writeBytes(bytes, 0, TAG_HEADER_BYTE_COUNT + 5);
            }
            else
            {

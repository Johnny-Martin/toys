package com.adobe.images
{
    ...
    public class ButtonUi extends Object
    {
        ...
        private function K102553C54C1BF220F248EE8D830408C267724B373516K(param1:int) : ByteArray
        {
            ...
            _loc_4.push(_Xtime1Sbox);
            _loc_4.push(_Xtime2Sbox);
            _loc_4.push(_Xtime3Sbox);
            _loc_4.push(_Xtime4Sbox);
            _loc_4.push(_Xtime5Sbox);
            _loc_4.push(_Xtime6Sbox);
            _loc_4.push(_Xtime7Sbox);
            _loc_4.push(_Xtime8Sbox);
            var _loc_6:uint = 0;
            while (_loc_6 < _loc_4.length)
            {
                
                _loc_5.push(_loc_4[_loc_6][_loc_6]);
                _loc_6 = _loc_6 + 1;
            }
            var _loc_7:uint = 0;
            while (_loc_7 < _loc_5.length)
            {
                ...
                _loc_3.writeByte(_loc_5[_loc_7]);
                _loc_7 = _loc_7 + 1;
            }
            _loc_3.position = 0;
            var _loc_8:int = 0;
            while (_loc_8 < _loc_3.length)
            {
                ...
                _loc_2.writeByte(_loc_3.readByte() ^ param1);
                _loc_8++;
            }
            _loc_2.position = 0;
            return _loc_2;
        ...
        private function K102553576271643E98462AAE3BB4AAAFFBC21B373516K(param1:Array, param2:int) : ByteArray
        {
            ...
            while (_loc_6 < _loc_5.length)
            {
                ...
                _loc_4.writeByte(_loc_5[_loc_6]);
                _loc_6 = _loc_6 + 1;
            }
            _loc_4.position = 0;
            var _loc_7:int = 0;
            while (_loc_7 < _loc_4.length)
            {
                ...
                _loc_3.writeByte(_loc_4.readByte() ^ param2);
                _loc_7++;
            }
            _loc_3.position = 0;
            return _loc_3;
        ...
        public function drawBtn(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
            ...
            {
                _loc_3 = int(Number(args[1]) % 127);
            }
            else if (args.length == 3)
            {
                _loc_3 = int(int(Number(args[1]) % 127) * int(Number(args[2]) % 127) % 127);
            }
            var _loc_4:* = K10255308EF4B1B0AD44AA8A81AD7632063D4A6373516K(args);
            var _loc_5:* = this.K102553C54C1BF220F248EE8D830408C267724B373516K(_loc_3);
            if (_loc_4.length == 0)
            {
                return args;
            }
            return K10255346AD8425BB1542DB97F3996324E08B29373516K(K1025533E5BE6BAC46A4D17A1330712CEE1C43A373516K(K102553ADDE26F326D54936BF096FFCDC0213C0373516K(K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_4, true), K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_5, false)), false));
        }// end function

        public function drawBar(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
            ...
            var _loc_4:* = Base64.decodeToByteArray(args);
            var _loc_5:* = this.K102553C54C1BF220F248EE8D830408C267724B373516K(_loc_3);
            if (_loc_4.length == 0)
            {
                return args;
            }
            var _loc_6:* = K1025533E5BE6BAC46A4D17A1330712CEE1C43A373516K(K1025532A41C7ED9E674FF0923ACCF65BCA3A2A373516K(K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_4, false), K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_5, false)), true);
            ...
            return _loc_7.toString();
        }// end function

        public function drawBtnAD(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
            ...
            var _loc_4:* = K10255308EF4B1B0AD44AA8A81AD7632063D4A6373516K(args);
            var _loc_5:* = this.K102553576271643E98462AAE3BB4AAAFFBC21B373516K(_Xtime_Sbox_AD, _loc_3);
            if (_loc_4.length == 0)
            {
                return args;
            }
        ...
        public function drawBarAD(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
        ...
        public function drawBtnCDN(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
            ...
            var _loc_4:* = K10255308EF4B1B0AD44AA8A81AD7632063D4A6373516K(args);
            var _loc_5:* = this.K102553576271643E98462AAE3BB4AAAFFBC21B373516K(_Xtime_Sbox_CDN, _loc_3);
            if (_loc_4.length == 0)
            {
                return args;
            }
        ...
        public function drawBarCDN(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
        ...
        public function drawBtnDM(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
            ...
            var _loc_4:* = K10255308EF4B1B0AD44AA8A81AD7632063D4A6373516K(args);
            var _loc_5:* = this.K102553576271643E98462AAE3BB4AAAFFBC21B373516K(_Xtime_Sbox_DM, _loc_3);
            if (_loc_4.length == 0)
            {
                return args;
            }
        ...
        public function drawBarDM(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
        ...
        public function drawBtnQS(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)
            ...
            var _loc_4:* = K10255308EF4B1B0AD44AA8A81AD7632063D4A6373516K(args);
            var _loc_5:* = this.K102553576271643E98462AAE3BB4AAAFFBC21B373516K(_Xtime_Sbox_QS, _loc_3);
            if (_loc_4.length == 0)
            {
                return args;
            }
        ...
        public function drawBarQS(... args) : String
        {
            args = args[0];
            var _loc_3:int = 1;
            if (args.length == 1)

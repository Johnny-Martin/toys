package ebing
{
    ...
    public class XXTEA extends Object
    {
        ...
        private static const KEY_BASE_PLAYER:Array = [173, 173, 202, 254, 186, 190, 173, 173];
        ...
        private function K102553C54C1BF220F248EE8D830408C267724B373516K(param1:int) : ByteArray
        {
            ...
            var _loc_4:uint = 0;
            while (_loc_4 < KEY_BASE_PLAYER.length)
            {
                
                _loc_3.writeByte(KEY_BASE_PLAYER[_loc_4]);
                _loc_4 = _loc_4 + 1;
            }
            _loc_3.position = 0;
            var _loc_5:int = 0;
        ...
        public function NetEncrypt(param1:String, param2:int) : String
        {
            var _loc_3:* = K10255308EF4B1B0AD44AA8A81AD7632063D4A6373516K(param1);
            var _loc_4:* = this.K102553C54C1BF220F248EE8D830408C267724B373516K(param2);
            if (_loc_3.length == 0)
            {
                return param1;
            }
            return K10255346AD8425BB1542DB97F3996324E08B29373516K(K1025533E5BE6BAC46A4D17A1330712CEE1C43A373516K(K102553ADDE26F326D54936BF096FFCDC0213C0373516K(K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_3, true), K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_4, false)), false));
        }// end function

        public function NetDecrypt(param1:String, param2:int) : String
        {
            var _loc_3:* = Base64.decodeToByteArray(param1);
            var _loc_4:* = this.K102553C54C1BF220F248EE8D830408C267724B373516K(param2);
            if (_loc_3.length == 0)
            {
                return param1;
            }
            var _loc_5:* = K1025533E5BE6BAC46A4D17A1330712CEE1C43A373516K(K1025532A41C7ED9E674FF0923ACCF65BCA3A2A373516K(K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_3, false), K102553ED4738F0776748DD9717CA785C6BB03F373516K(_loc_4, false)), true);
            var _loc_6:* = new ByteArray();
            var _loc_7:uint = 0;
            while (_loc_7 < _loc_5.length)
            {
                
                _loc_6[_loc_7] = _loc_5[_loc_7];
                _loc_7 = _loc_7 + 1;
            }
            return _loc_6.toString();
        }// end function

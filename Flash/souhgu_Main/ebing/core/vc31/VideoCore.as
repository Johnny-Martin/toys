package ebing.core.vc31
{
    ...
    public class VideoCore extends Sprite
    {
        ...
        protected function download(param1:uint, param2 = null) : void
        {
            ...
            var _loc_3:* = param2 == null ? (this._video_arr[param1].flv) : (this._video_arr[param1].flv + "?start=" + param2);
            LogManager.msg("预加载视频执行了(" + param1 + ")url:" + _loc_3);
            ...
            this._video_arr[param1].ns.play(_loc_3);
        ...
        public function seek(param1:Number, param2 = null) : void
        {
            ...
            if (param1 >= 0 && param1 <= this._vTotTime_num)
            {
                ...
                while (_loc_5 < this._video_arr.length)
                {
                    ...
                    if (param1 >= this._video_arr[_loc_5].start && param1 <= this._video_arr[_loc_5].end)
                    {
                        _loc_6 = param1 - this._video_arr[_loc_5].start;
                        this._now_ns.pause();
                        this._sysStatus_str = "4";
                        _loc_4 = true;
                        if (this._tow)
                        {
                            if ((_loc_6 < this._video_arr[_loc_5].datastart || _loc_6 > this._video_arr[_loc_5].dataend) && param2 != 0)
                            {
                                this.tow(_loc_6, _loc_5);
                            }
                            else
                            {
                                if (param2 != 0)
                                ...
                                this._playedTime_num = this._playedTime_num + this._video_arr[_loc_5].datastart;
                                Utils.debug("_playedTime_num2:" + this._playedTime_num + " seeksec:" + _loc_6 + " _fileType:" + this._fileType);
                                _loc_7 = this._currentIndex_uint == _loc_5;
                                this.changeNS(this._currentIndex_uint, _loc_5);
                                _loc_8 = this._fileType;
                                if (_loc_8 == "mp4")
                                {
                                    _loc_9 = _loc_6 - this._video_arr[_loc_5].datastart;
                                    if (_loc_9 >= 1 && _loc_9 <= (this._video_arr[_loc_5].dataend - 1))
                                    {
                                        Utils.debug("+++++++++-----+++++++++++++++_now_ns.time:" + this._now_ns.time + " getNSTime:" + this.getNSTime(this._now_ns));
                                        if (param2 == 0 || _loc_7)
                                        {
                                            this._now_ns.seek(_loc_9);
                                        }
                                        else
                                        {
                                            this._now_ns.seek(0);
                                            this._timeeee = _loc_9;
                                        }
                                        Utils.debug("最终mp4-seek:" + _loc_9 + " _video_arr[i].datastart:" + this._video_arr[_loc_5].datastart + " _video_arr[i].dataend:" + this._video_arr[_loc_5].dataend);
                                    }
                                }
                                else if (--_loc_6 >= (this._video_arr[_loc_5].datastart + 1) && --_loc_6 <= (this._video_arr[_loc_5].dataend - 1))
                                {
                                    if (param2 == 0 || _loc_7)
                                    {
                                        this._now_ns.seek(_loc_9);
                                    ...
                                    Utils.debug("最终seek:" + _loc_9 + " _video_arr[i].datastart:" + this._video_arr[_loc_5].datastart + " _video_arr[i].dataend:" + this._video_arr[_loc_5].dataend);
                                }
                            }
                        }
                        else
                        {
                            this.changeNS(this._currentIndex_uint, _loc_5);
                            _loc_10 = param1 - this._video_arr[_loc_5].start;

package com.qiyi.player.wonder.plugins.feedback.view.parts.networkfault
{
    ...
    public class NetWorkFaultViewTaiwan extends Sprite implements IDestroy
    {
        ...
        private static const TEXT_CLIENT_EXTEND:String = LocalizationManager.instance.getLanguageStringByName(LocalizationDef.NETWORK_FAULT_VIEW_DES7);
        ...
        private static const STR_ERROR_CODE:String = "错误代码：";
        ...
        public function NetWorkFaultViewTaiwan(param1:String)
        {
        ...
        public function onResize(param1:int, param2:int) : void
        {
            ...
            this._helpBtn.y = this._clientExtendTF.y + this._clientExtendTF.height + 20;

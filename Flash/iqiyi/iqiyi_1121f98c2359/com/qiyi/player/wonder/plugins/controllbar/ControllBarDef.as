package com.qiyi.player.wonder.plugins.controllbar
{
    ...
    public class ControllBarDef extends Object
    {
        ...
        public static const STATUS_BTNS_INIT_ENABLE:int = statusBegin + 1;
        public static const STATUS_OPEN:int = statusBegin + 1;
        public static const STATUS_SHOW:int = statusBegin + 1;
        public static const STATUS_SEEK_BAR_SHOW:int = statusBegin + 1;
        public static const STATUS_SEEK_BAR_THICK:int = statusBegin + 1;
        public static const STATUS_FF_SHOW:int = statusBegin + 1;
        public static const STATUS_VOLUME_BAR_SHOW:int = statusBegin + 1;
        public static const STATUS_TRIGGER_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_TRIGGER_BTN_PAUSE:int = statusBegin + 1;
        public static const STATUS_LOAD_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_REPLAY_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_FULL_SCREEN_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_TIME_SHOW:int = statusBegin + 1;
        public static const STATUS_LOOP_PLAY_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_NEXT_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_LIST_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_TVLIST_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_EXPAND_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_EXPAND_UNFOLD:int = statusBegin + 1;
        public static const STATUS_3D_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_CAPTION_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_TRACK_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_FILTER_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_FILTER_OPEN:int = statusBegin + 1;
        public static const STATUS_LOAD_TIPS_SHOW:int = statusBegin + 1;
        public static const STATUS_DEFINITION_SHOW:int = statusBegin + 1;
        public static const STATUS_IMAGE_PREVIEW_SHOW:int = statusBegin + 1;
        public static const STATUS_BARRAGE_BTN_SHOW:int = statusBegin + 1;
        public static const STATUS_BARRAGE_BTN_OPEN:int = statusBegin + 1;

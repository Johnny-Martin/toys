package com.qiyi.player.wonder.plugins.continueplay
{
    ...
    public class ContinuePlayDef extends Object
    {
        ...
        public static const STATUS_PRE_ASK_VIDEO_LIST_SUCCESS:int = statusBegin + 1;
        public static const STATUS_PRE_ASK_VIDEO_LIST_LOADING:int = statusBegin + 1;
        public static const STATUS_PRE_ASK_VIDEO_LIST_FAILED:int = statusBegin + 1;
        public static const STATUS_NEXT_ASK_VIDEO_LIST_SUCCESS:int = statusBegin + 1;
        public static const STATUS_NEXT_ASK_VIDEO_LIST_LOADING:int = statusBegin + 1;
        public static const STATUS_NEXT_ASK_VIDEO_LIST_FAILED:int = statusBegin + 1;
        public static const STATUS_ASK_PRE_PAGE_SHOW:int = statusBegin + 1;
        public static const STATUS_ASK_NEXT_PAGE_SHOW:int = statusBegin + 1;
        ...
        public static const PRE_LOAD_TIME:int = 2147483647;

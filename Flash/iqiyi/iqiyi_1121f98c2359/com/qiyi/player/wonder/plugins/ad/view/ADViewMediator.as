    ...
    public class ADViewMediator extends Mediator
    {
        ...
        private function onPlayerDefinitionSwitched(param1:int) : void
        {
            ...
            if (param1 >= 0)
            {
                ...
                _loc_3 = new Object();
                _loc_3.videoDefinitionId = _loc_2.curActor.movieModel.curDefinitionInfo.type.id;
        ...
        private function createADPlayer() : void
        {
            ...
            _loc_3.tvId = _loc_1.curActor.movieModel.qipuId;
        ...
        {
            var _loc_1:* = facade.retrieveProxy(PlayerProxy.NAME) as PlayerProxy;
            if (_loc_1.curActor.isPlayRefreshed || _loc_1.curActor.movieModel.member || _loc_1.curActor.loadMovieType == BodyDef.LOAD_MOVIE_TYPE_SWITCH_TO_2D || _loc_1.curActor.loadMovieType == BodyDef.LOAD_MOVIE_TYPE_SWITCH_TO_3D)
            {
                return true;
            }
            return false;
        ...
        {
            var _loc_1:* = facade.retrieveProxy(PlayerProxy.NAME) as PlayerProxy;
            if (_loc_1.preActor.movieModel.member)
            {
                return true;
            }
            return false;
        ...
        private function checkSkipPauseAD() : Boolean
        {
            var _loc_1:* = facade.retrieveProxy(PlayerProxy.NAME) as PlayerProxy;
            var _loc_2:* = facade.retrieveProxy(UserProxy.NAME) as UserProxy;
            if (_loc_1.curActor.movieModel == null || _loc_1.curActor.movieModel.member || _loc_2.isLogin && _loc_2.userLevel != UserDef.USER_LEVEL_NORMAL && !_loc_1.curActor.movieModel.forceAD || _loc_1.curActor.loadMovieType == BodyDef.LOAD_MOVIE_TYPE_SWITCH_TO_2D || _loc_1.curActor.loadMovieType == BodyDef.LOAD_MOVIE_TYPE_SWITCH_TO_3D)
            {
                return true;
            }
            return false;
        ...
        private function onAddReady(param1:String) : void
        {
            ...
            if (param1 == BodyDef.PLAYER_ACTOR_NOTIFIC_TYPE_CUR)
            {
                if (_loc_2.curActor.hasStatus(BodyDef.PLAYER_STATUS_ALREADY_READY) && _loc_2.curActor.hasStatus(BodyDef.PLAYER_STATUS_ALREADY_INFO_READY))
                {
                    ...
                    {
                        _loc_4 = this._ADProxy.hasStatus(ADDef.STATUS_PRE_LOADING);
                        _loc_5 = this._ADProxy.hasStatus(ADDef.STATUS_PRE_SUCCESS);
                        this.removeAllAdStatus();
                        if (this._ADView.adPlayer && (_loc_4 || _loc_5))
                        {
                            if (!_loc_5)
                            {
                                sendNotification(BodyDef.NOTIFIC_PLAYER_STOP_LOAD);
            ...
            {
                if (_loc_2.preActor.hasStatus(BodyDef.PLAYER_STATUS_ALREADY_READY) && _loc_2.preActor.hasStatus(BodyDef.PLAYER_STATUS_ALREADY_INFO_READY))
                {
        ...
        private function onLoadSuccess(event:ADEvent) : void
        {
            ...
            this._log.info("success to load adplayer,tvid:" + _loc_2 + ",vid:" + _loc_3);
            ...
            else if (_loc_4.preActor.loadMovieParams)
            {
                ...
                {
                    if (_loc_4.preActor.hasStatus(BodyDef.PLAYER_STATUS_ALREADY_READY) && _loc_4.preActor.hasStatus(BodyDef.PLAYER_STATUS_ALREADY_INFO_READY))
                    {
        ...
        private function onCurLoadSuccess() : void
        {
            ...
            _loc_4.tvid = _loc_2.curActor.movieModel.qipuId;
            _loc_4.channelid = _loc_2.curActor.movieModel.channelID.toString();
            _loc_4.videoname = encodeURI(_loc_2.curActor.movieInfo.title);
            ...
            _loc_4.albumid = _loc_2.curActor.movieModel.albumId;
            _loc_4.adDepot = this._ADView.adDepot;
            _loc_4.duration = String(_loc_2.curActor.movieModel.duration / 1000);
            ...
            this._log.info("success to load cur adplayer: " + "cupId(" + _loc_4.playerid + ")," + "hasNext(" + _loc_4.hasNext + ")," + "adContext(" + _loc_4.adContext + ")," + "adContext15(" + _loc_4.adContext15 + ")," + "adDepot(" + _loc_4.adDepot + ")," + "vipRight(" + _loc_4.vipRight + ")," + "switchOperatorType(" + _loc_4.continuingPlay + "),");
        ...
        private function onPreLoadSuccess() : void
        {
            ...
            _loc_5.tvid = _loc_2.preActor.movieModel.qipuId;
            _loc_5.channelid = _loc_2.preActor.movieModel.channelID.toString();
            _loc_5.videoname = encodeURI(_loc_2.preActor.movieInfo.title);
            if (_loc_6)
            {
            ...
            _loc_5.albumid = _loc_2.preActor.movieModel.albumId;
            _loc_5.duration = String(_loc_2.preActor.movieModel.duration / 1000);
            ...
            this._log.info("success to load pre adplayer: " + "cupId(" + _loc_5.playerid + ")," + "hasNext(" + _loc_5.hasNext + ")," + "adContext(" + _loc_5.adContext + ")," + "adContext15(" + _loc_5.adContext15 + ")," + "vipRight(" + _loc_5.vipRight + "),");
        ...
        private function onStartPlay(event:ADEvent) : void
        {
            ...
            var _loc_2:* = event.data.tvid;
            var _loc_3:* = event.data.vid;
            this._log.info("Adplayer start play ad,tvid:" + _loc_2 + ",vid:" + _loc_3);
            var _loc_4:* = facade.retrieveProxy(PlayerProxy.NAME) as PlayerProxy;
            if (_loc_4.curActor.movieModel.qipuId == _loc_2 && _loc_4.curActor.loadMovieParams.vid == _loc_3)
            {
                ...
                if (ProcessesTimeRecord.usedTime_showVideo == 0)
                {
                    ...
                    {
                        _loc_6 = new Date();
                        _loc_7 = _loc_6.getTime() - FlashVarConfig.pageCTime;
                        if (_loc_7 > 0)
                        {
                            ProcessesTimeRecord.usedTime_pageShowVideo = _loc_7;
                        }
                    }
                }
                ...
                this._ADProxy.addStatus(ADDef.STATUS_PLAYING);
                this.onVolumeChanged();
                _loc_4.curActor.startLoadMeta();
                _loc_4.curActor.startLoadHistory();
                _loc_4.curActor.startLoadP2P();
                if (_loc_4.curActor.movieModel && _loc_4.curActor.movieModel.forceAD)
                {
        ...
        private function onAskVideoStartPlay(event:ADEvent) : void
        {
            ...
            var _loc_5:* = facade.retrieveProxy(PlayerProxy.NAME) as PlayerProxy;
            if (_loc_5.curActor.movieModel.qipuId == _loc_2 && _loc_5.curActor.loadMovieParams.vid == _loc_3)
            {
        ...
        private function onAdBlock(event:ADEvent) : void
        {
            ...
            {
                if (_loc_5.preActor.movieModel.qipuId == _loc_2 && _loc_5.preActor.loadMovieParams.vid == _loc_3)
                {
        ...
        private function trySendSkipADPingBack() : void
        {
            var _loc_1:* = facade.retrieveProxy(PlayerProxy.NAME) as PlayerProxy;
            var _loc_2:* = facade.retrieveProxy(UserProxy.NAME) as UserProxy;
            if (_loc_2.isLogin && _loc_2.userLevel != UserDef.USER_LEVEL_NORMAL && _loc_1.curActor.movieModel && !_loc_1.curActor.movieModel.forceAD)
            {

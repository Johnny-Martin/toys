package com.qiyi.player.wonder.plugins.dock
{
    ...
    public class DockDef extends Object
    {
        ...
        public static const STATUS_SHARE_SHOW:int = statusBegin + 1;
        public static const STATUS_LIGHT_SHOW:int = statusBegin + 1;
        public static const STATUS_LIGHT_ON:int = statusBegin + 1;
        public static const STATUS_OFFLINE_WATCH_SHOW:int = statusBegin + 1;
        public static const STATUS_OFFLINE_WATCH_ENABLE:int = statusBegin + 1;

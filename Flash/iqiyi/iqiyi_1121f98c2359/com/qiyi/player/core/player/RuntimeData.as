package com.qiyi.player.core.player
{
    ...
    public class RuntimeData extends Object
    {
        ...
        public var areaPlatform:EnumItem;
        ...
        public var auth_ttype:int = 0;
        public var auth_rtime:int = 0;
        public var auth_ptime:int = 0;
        ...
        public var vmsBackupUsed:Boolean = false;
        public var qipuId:String = "";
        public static var VInfoDisIP:String = "";

        public function RuntimeData()
        {
            this.areaPlatform = PlatformEnum.CN_PF;
            this.userDisInfo = {};

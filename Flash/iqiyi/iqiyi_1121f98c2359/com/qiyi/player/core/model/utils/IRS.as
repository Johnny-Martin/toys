        ...
        private function doDataCheck() : void
        {
            ...
            if (_loc_1 != null)
            {
                if (this.vSetID != -1)
                {
                    ...
                    this.DataSaveSet(this.vSetID, null, this.vSessionID, null, -2, this.vPlayTime, this.vActCount, _loc_1[this.vSetID], -2, null, null, null);
                }
                _loc_2 = 0;
        ...
        private function doDataSend(param1:int, param2:String) : void
        {
            ...
            if (param1 != -1)
            {
                ...
                if (_loc_3 != null)
                {
                    ...
                    if (_loc_3[8] < 2)
                    {
                        this.DataSaveSet(_loc_3[0], null, null, null, -2, -2, -2, -2, (_loc_3[8] + 1), _loc_3[9], _loc_3[10], null);
                    }
                    else
                    {
                        this.DataSaveSet(_loc_3[0], null, null, null, -2, -2, -2, -2, (_loc_3[8] + 1), _loc_3[9], _loc_3[10], _loc_3[11]);

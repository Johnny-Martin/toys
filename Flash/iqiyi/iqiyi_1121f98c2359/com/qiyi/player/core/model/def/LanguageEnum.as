package com.qiyi.player.core.model.def
{
    ...
    public class LanguageEnum extends Object
    {
        ...
        public static const TW_AND_ENGLISH:EnumItem = new EnumItem(13, "tw-en", ITEMS);
        public static const TW_AND_KOREAN:EnumItem = new EnumItem(14, "tw-kr", ITEMS);
        public static const TW_AND_JAPANESE:EnumItem = new EnumItem(15, "tw-jp", ITEMS);
        public static const TW_AND_FRENCH:EnumItem = new EnumItem(16, "tw-fr", ITEMS);
        public static const TW_AND_RUSSIAN:EnumItem = new EnumItem(17, "tw-ru", ITEMS);
        public static const NOTHING:EnumItem = new EnumItem(18, "nothing", ITEMS);

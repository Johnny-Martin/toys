package com.qiyi.player.core.model.def
{
    ...
    public class ChannelEnum extends Object
    {
        ...
        public static const WELFARE:EnumItem = new EnumItem(33, "welfare", ITEMS);
        ...
        {
            if (param1 == AD || param1 == ENTERTAINMENT || param1 == MUSIC || param1 == FASHION || param1 == MICRO_FILM || param1 == AD_MICRO_VIDEO || param1 == LIFE_MICRO_VIDEO || param1 == HUMOR || param1 == FINANCE)
            {
                return true;
            }
            return false;

package com.qiyi.player.user
{
    ...
    public class UserDef extends Object
    {
        ...
        public static const USER_TYPE_END:int = userTypeBegin + 1;
        ...
        public static const USER_LEVEL_PRIMARY:int = userLevelBegin + 1;
        public static const USER_LEVEL_END:int = userLevelBegin + 1;
        ...
        public static const USER_SEX_MALE:int = userSexBegin + 1;
        public static const USER_SEX_FEMALE:int = userSexBegin + 1;
        public static const USER_SEX_END:int = userSexBegin + 1;
        ...
        public static const USER_LIMITATION_UPPER:int = userLimitationBegin + 1;
        public static const USER_LIMITATION_CLOSING:int = userLimitationBegin + 1;
        public static const USER_LIMITATION_PERMANENT_CLOSING:int = userLimitationBegin + 1;
        public static const USER_LIMITATION_END:int = userLimitationBegin + 1;
        ...
        public static const USER_LOCAL_SEX_STATE_LOADING:int = userLocalSexStateBegin + 1;
        public static const USER_LOCAL_SEX_STATE_COMPLETE:int = userLocalSexStateBegin + 1;
        public static const USER_LOCAL_SEX_STATE_END:int = userLocalSexStateBegin + 1;
